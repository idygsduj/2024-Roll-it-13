...
To begin, decide the overall score needed to be crowned the winner of the game (eg: first person to get a 
score of 50 or more).
...
# initialise user score and computer scores and game history
user_score = 0
comp_score = 0
